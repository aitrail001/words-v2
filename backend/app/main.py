...
from app.api.admin_import_jobs import router as admin_import_jobs_router
...
app.include_router(admin_import_jobs_router, prefix="/api/admin/import-jobs", tags=["admin-import-jobs"])
