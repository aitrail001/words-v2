...
## Corpus Check
- 491 files · ~714,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5716 nodes · 12998 edges · 397 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 2839 edges (avg confidence: 0.5)
...
2. `Word` - 184 edges
3. `Meaning` - 177 edges
4. `ReviewService` - 164 edges
5. `PhraseEntry` - 119 edges
...
- `VoiceImportSummary` --uses--> `LexiconVoiceAsset`  [INFERRED]
  tools/lexicon/voice_import_db.py → backend/app/models/lexicon_voice_asset.py
- `VoiceImportSummary` --uses--> `LexiconVoiceStoragePolicy`  [INFERRED]
  tools/lexicon/voice_import_db.py → backend/app/models/lexicon_voice_storage_policy.py
- `VoiceImportSummary` --uses--> `Meaning`  [INFERRED]
  tools/lexicon/voice_import_db.py → backend/app/models/meaning.py
- `VoiceImportSummary` --uses--> `MeaningExample`  [INFERRED]
  tools/lexicon/voice_import_db.py → backend/app/models/meaning_example.py
- `VoiceImportSummary` --uses--> `PhraseEntry`  [INFERRED]
  tools/lexicon/voice_import_db.py → backend/app/models/phrase_entry.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (463): CreateAdminImportBatchRequest, AdminImportSourceBulkDeleteRequest, AdminImportSourceDeleteResult, LoginRequest, RefreshRequest, RegisterRequest, Base, BaseModel (+455 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (335): __(), _0, a_, A0, AA(), ac(), Ad(), aE() (+327 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (96): build_batch_result_rows(), _extract_batch_response_body(), ingest_batch_outputs(), _materialize_batch_phrase_row(), _materialize_batch_word_row(), Batch output ingestion helpers for lexicon offline runs., _stable_hash(), build_batch_request_rows() (+88 more)
...
Cohesion: 0.02
Nodes (31): EntryReviewEvent, EntryReviewState, TestLearnerEntryStatusModel, TestSearchHistoryModel, TestUserPreferenceModel, _frozen_datetime_class(), _load_timezone_safe_migration(), test_get_due_queue_items_does_not_unlock_future_official_schedule_after_eastward_timezone_change() (+23 more)
...
Cohesion: 0.06
Nodes (46): build_import_cache_key(), build_review_entries_query(), _build_title_candidates(), _clean_person_name(), _collect_content_fallbacks(), _collect_metadata_entries(), _collect_metadata_refinements(), create_word_list_from_entries() (+38 more)
...
Cohesion: 0.1
Nodes (31): cancel_lexicon_job(), _compiled_batch_or_404(), create_compiled_materialize_job(), create_compiled_review_bulk_update_job(), create_import_db_job(), create_jsonl_materialize_job(), create_voice_import_db_job(), _enqueue_or_503() (+23 more)
...
Cohesion: 0.13
Nodes (34): _artifact_family(), _artifact_sha256_bytes(), _batch_or_404(), _batch_response(), _batch_reviewed_output_dir(), bulk_update_compiled_review_batch(), _canonical_json_bytes(), _compiled_meaning_limit() (+26 more)
...
Cohesion: 0.28
Nodes (22): _compiled_reference_row(), _compiled_reference_row_with_warning(), _compiled_rows(), _compiled_rows_with_warning(), _invalid_compiled_word_row(), make_user(), test_bulk_patch_returns_actionable_error_when_decisions_path_is_not_writable(), test_bulk_patch_updates_all_rows_and_returns_updated_session() (+14 more)
...
Cohesion: 0.13
Nodes (7): LexiconArtifactReviewItemEvent, LexiconRegenerationRequest, TestLexiconArtifactReviewBatchModel, TestLexiconArtifactReviewEventModel, TestLexiconArtifactReviewItemModel, TestLexiconCompiledReviewTables, TestLexiconRegenerationRequestModel
...
Cohesion: 0.33
Nodes (12): _build_rubric_summary(), _default_case_runner(), _failure_rows_without_lemma(), _lemma_from_sense_id(), _load_case_progress(), load_enrichment_benchmark_metadata(), load_enrichment_benchmark_words(), _resolve_benchmark_path() (+4 more)
...
Cohesion: 0.23
Nodes (7): get_me(), login(), refresh_tokens(), register(), RegisterResponse, TokenResponse, UserResponse
...
Cohesion: 0.36
Nodes (10): _build_client(), build_rerank_prompt(), _candidate_senses_for_lemma(), _full_wordnet_candidates(), _normalize_provider_candidates(), _resolve_candidate_senses(), run_rerank(), _snapshot_selected_candidates() (+2 more)

### Community 81 - "Community 81"
Cohesion: 0.4
Nodes (10): normalize_confidence(), normalize_confusable_words(), normalize_examples(), normalize_forms(), normalize_optional_enum(), normalize_string_list_field(), normalize_translation_payload(), _payload_error() (+2 more)

### Community 82 - "Community 82"
Cohesion: 0.31
Nodes (7): add_epub_files_to_batch(), _build_fallback_summary(), _create_epub_batch_record(), create_epub_import_batch(), create_import_batch(), _enqueue_files_into_batch(), _serialize_job()

### Community 83 - "Community 83"
Cohesion: 0.27
Nodes (5): create_word_list_from_import_job(), _default_word_list_description_for_import_job(), _default_word_list_name_for_import_job(), _import_cache_deleted_detail(), list_import_job_entries()

### Community 84 - "Community 84"
Cohesion: 0.27
Nodes (7): apply_lexicon_job_cancelled(), apply_lexicon_job_completed(), apply_lexicon_job_failed(), apply_lexicon_job_progress(), apply_lexicon_job_started(), create_or_reuse_lexicon_job(), _now()

### Community 85 - "Community 85"
Cohesion: 0.27
Nodes (6): make_admin(), test_add_epub_files_to_existing_batch_enqueues_jobs(), test_create_epub_import_batch_falls_back_when_summary_load_fails(), test_create_epub_import_batch_rejects_too_many_files(), test_create_epub_import_batch_returns_failures_and_rolls_back_after_enqueue_exception(), test_create_import_batch_returns_empty_epub_batch()
...
Cohesion: 0.36
Nodes (9): excluded_canonical_forms(), load_distinct_variant_entries(), load_entity_categories(), load_tail_exclusions(), _normalize_distinct_variant_map(), _normalize_word_map(), resolve_distinct_variant_entry(), resolve_entity_category() (+1 more)

### Community 88 - "Community 88"
Cohesion: 0.4
Nodes (9): build_phrase_inventory_records(), map_reviewed_phrase_kind(), _normalize_added_flag(), _normalize_optional_float(), _normalize_optional_int(), _normalize_optional_text(), _provenance_from_row(), Helpers for building normalized phrase inventory rows from reviewed CSV sources. (+1 more)

### Community 89 - "Community 89"
Cohesion: 0.42
Nodes (9): build_snapshot_id(), make_concept_id(), make_enrichment_id(), make_entry_id(), make_lexeme_id(), make_sense_id(), _slug_with_suffix(), _slugify() (+1 more)

### Community 90 - "Community 90"
Cohesion: 0.36
Nodes (5): _compiled_phrase_row_with_warning(), _compiled_reference_row_with_warning(), _compiled_word_row(), _phonetics(), ReviewPrepTests

### Community 91 - "Community 91"
Cohesion: 0.33
Nodes (2): PhraseEnrichmentSchemaTests, _translations()

### Community 92 - "Community 92"
Cohesion: 0.31
Nodes (7): _base_enrichment_item_schema(), build_single_sense_response_schema(), build_word_enrichment_response_schema(), _nullable_schema(), _phonetic_variant_schema(), _phonetics_schema(), Word enrichment schema helpers.

### Community 93 - "Community 93"
Cohesion: 0.33
Nodes (9): build_phrase_enrichment_response_schema(), normalize_phrase_enrichment_payload(), _normalize_phrase_translation_payload(), _normalize_phrase_translation_usage_note(), _nullable_schema(), _phrase_example_schema(), Phrase enrichment schema helpers., _sense_schema() (+1 more)

### Community 94 - "Community 94"
Cohesion: 0.33
Nodes (7): persistPreferences(), updateAccent(), updateReviewDepthPreset(), updateShowPictures(), updateShowTranslations(), updateTranslationLocale(), updateView()

### Community 95 - "Community 95"
Cohesion: 0.29
Nodes (6): fetchAudioBlobUrl(), getPlayableLearnerAccents(), localeToAccent(), normalizePlaybackPath(), playLearnerEntryAudio(), resolveLearnerVoiceAsset()

### Community 96 - "Community 96"
Cohesion: 0.4
Nodes (9): _acquire_import_source_lock(), _cleanup_uploaded_file(), extract_epub_vocabulary(), _import_source_lock_key(), _mark_linked_jobs(), process_source_import(), process_word_list_import(), _release_import_source_lock() (+1 more)

### Community 97 - "Community 97"
Cohesion: 0.38
Nodes (9): build_available_prompt_types(), build_card_prompt(), _build_v1_deep_hard_prompt_types(), load_definition_target_distractors(), load_entry_target_distractors(), load_prompt_audio_for_type(), load_prompt_distractors(), resolve_prompt_preferences() (+1 more)

### Community 98 - "Community 98"
Cohesion: 0.5
Nodes (8): build_audit_inventory(), _is_common_contraction(), _load_by_key(), _load_canonical_rule_sets(), main(), _non_plural_suffix_candidates(), _plural_suffix_candidates(), _risk_buckets()

### Community 99 - "Community 99"
Cohesion: 0.53
Nodes (8): _compiled_rows(), _phonetics(), test_materialize_review_outputs_happy_path(), test_materialize_review_outputs_rejects_duplicate_decisions(), test_materialize_review_outputs_rejects_missing_full_batch_decisions(), test_materialize_review_outputs_rejects_mixed_artifact_hashes(), test_materialize_review_outputs_rejects_unknown_entry_ids(), _write_jsonl()
...
Cohesion: 0.28
Nodes (4): _build_sources_base_query(), get_admin_import_source_detail(), list_admin_import_sources(), soft_delete_import_source_cache()
...
Cohesion: 0.25
Nodes (2): LexiconReviewBatch, LexiconReviewItem
...
## Knowledge Gaps
- **83 isolated node(s):** `g2`, `Shared review-preparation helpers for realtime and batch lexicon artifacts.`, `QC helpers for lexicon offline runs.`, `Thin Batch API client helpers for the lexicon offline pipeline.`, `Thin, injectable batch transport boundary.` (+78 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 271`** (2 nodes): `compare_selection_artifacts()`, `compare_selection.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 272`** (2 nodes): `wordfreq_provider.py`, `build_wordfreq_rank_provider()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (2 nodes): `page.tsx`, `formatCount()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (2 nodes): `page.test.tsx`, `resolveSyncRequest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (2 nodes): `page.tsx`, `buildTileGradient()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (2 nodes): `page.tsx`, `KnowledgeMapRangePage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (2 nodes): `page.tsx`, `PhraseEntryPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (2 nodes): `page.tsx`, `ImportJobDetailRoute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (2 nodes): `page.tsx`, `rememberSearch()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (2 nodes): `page.tsx`, `RegisterPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (2 nodes): `page.test.tsx`, `renderPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (2 nodes): `page.tsx`, `getPromptTypeLabel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (2 nodes): `page.tsx`, `WordListsPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (2 nodes): `page.tsx`, `WordListDetailRoute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (2 nodes): `page.tsx`, `WordEntryPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (2 nodes): `page.tsx`, `KnowledgeListPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (2 nodes): `word-list-detail-page.tsx`, `WordListDetailPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (2 nodes): `knowledge-entry-detail-page.test.tsx`, `formatReviewTime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (2 nodes): `uploads.py`, `resolve_upload_dir()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (2 nodes): `get_admin_import_job()`, `admin_import_jobs.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (2 nodes): `page.tsx`, `LexiconPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (2 nodes): `page.tsx`, `LexiconEpubCacheRootPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (2 nodes): `page.tsx`, `LexiconLegacyPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (2 nodes): `page.test.tsx`, `buildVoiceJob()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (2 nodes): `voice-storage-panel.tsx`, `VoiceStoragePanel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (2 nodes): `page.tsx`, `LexiconVoiceLegacyPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (2 nodes): `page.test.tsx`, `snapshotPageResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (2 nodes): `page.test.tsx`, `buildImportJob()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (2 nodes): `path-guidance-card.tsx`, `PathGuidanceCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (2 nodes): `epub-cache-nav.tsx`, `EpubCacheNav()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (2 nodes): `horizontal-record-rail.tsx`, `HorizontalRecordRail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (2 nodes): `section-nav.tsx`, `LexiconSectionNav()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (2 nodes): `paged-record-list.tsx`, `PagedRecordList()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (2 nodes): `admin-import-jobs-client.ts`, `getAdminImportJob()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (2 nodes): `browser-location.ts`, `assignLocation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (2 nodes): `buildCompiledWordRow()`, `admin-compiled-review-bulk-job.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (2 nodes): `buildCompiledWordRow()`, `admin-lexicon-ops-import-flow.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (2 nodes): `buildCompiledWordRow()`, `admin-compiled-review-flow.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (2 nodes): `buildCompiledWordRow()`, `admin-compiled-review-bulk-job.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (2 nodes): `buildCompiledWordRow()`, `admin-lexicon-ops-import.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (2 nodes): `buildCompiledWordRow()`, `admin-compiled-review.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (2 nodes): `selectCompiledReviewBatch()`, `compiled-review.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (2 nodes): `review-seed.ts`, `seedDueReviewItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (2 nodes): `epub-fixture.ts`, `ensureMinimalEpubFixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (2 nodes): `import-jobs.ts`, `waitForImportJobTerminal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (2 nodes): `paths.ts`, `resolveWorkspaceDataRoot()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `jest.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `next-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `jest.setup.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `next.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 330`** (1 nodes): `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `learner-list-rows.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `knowledge-map-range-detail.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `store.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `api-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `knowledge-map-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `learner-audio.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `user-preferences-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `imports-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `celery_app.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Refuse to start in production with known-bad secrets.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `Parse and strip whitespace from allowed origins.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `Allow common loopback origins during local development.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 359`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `jest.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (1 nodes): `next-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `jest.setup.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `next.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 371`** (1 nodes): `page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (1 nodes): `reviewer-summary-card.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 373`** (1 nodes): `lexicon-jobs-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 374`** (1 nodes): `auth-redirect.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 375`** (1 nodes): `lexicon-compiled-reviews-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 376`** (1 nodes): `lexicon-jsonl-reviews-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 377`** (1 nodes): `words-client.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 378`** (1 nodes): `browser-location.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 379`** (1 nodes): `playwright.local.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 380`** (1 nodes): `playwright.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 381`** (1 nodes): `user-auth-guard.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 382`** (1 nodes): `user-review-typed-normalization.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 383`** (1 nodes): `user-real-voice-playback.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 384`** (1 nodes): `user-auth-contract.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 385`** (1 nodes): `user-review-confidence-and-pictures.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 386`** (1 nodes): `user-import-create.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 387`** (1 nodes): `user-register-review-empty.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 388`** (1 nodes): `admin-lexicon-voice-import-flow.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 389`** (1 nodes): `user-import-domain.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 390`** (1 nodes): `user-knowledge-map.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 391`** (1 nodes): `admin-epub-cache.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 392`** (1 nodes): `admin-auth.smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 393`** (1 nodes): `user-import-review-create.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 394`** (1 nodes): `admin-lexicon-voice-import.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 395`** (1 nodes): `user-import-terminal.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 396`** (1 nodes): `user-dashboard-search.full.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `LexiconDependencyError` connect `Community 2` to `Community 16`, `Community 10`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `User` connect `Community 0` to `Community 261`, `Community 5`, `Community 74`, `Community 75`, `Community 112`, `Community 22`, `Community 56`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ActiveLexiconJobConflictError` connect `Community 0` to `Community 16`, `Community 84`?**
...
- **Are the 180 inferred relationships involving `Word` (e.g. with `VoiceImportSummary` and `VoiceManifestGroup`) actually correct?**
  _`Word` has 180 INFERRED edges - model-reasoned connections that need verification._
- **Are the 173 inferred relationships involving `Meaning` (e.g. with `VoiceImportSummary` and `VoiceManifestGroup`) actually correct?**
  _`Meaning` has 173 INFERRED edges - model-reasoned connections that need verification._
