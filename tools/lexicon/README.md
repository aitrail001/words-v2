...
- `build-base` now checks the local word DB by default and skips canonical words that already exist there; pass `--rerun-existing` to force regeneration for already-published words
