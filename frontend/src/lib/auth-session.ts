export const ACCESS_TOKEN_STORAGE_KEY = "words_access_token";
export const ACCESS_TOKEN_COOKIE_KEY = "words_access_token";
export const REFRESH_TOKEN_STORAGE_KEY = "words_refresh_token";
export const AUTH_TOKEN_CHANGED_EVENT = "words:auth-token-changed";
...
const writeStorageValue = (key: string, value: string | null): void => {
  ...
  try {
    ...
    // Ignore storage write failures and still synchronize cookie + nav state.
  }
};
